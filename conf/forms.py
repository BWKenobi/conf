...
class UserRegistrationForm(forms.ModelForm):
	...
	speaker = forms.ChoiceField(label = 'Форма участия', initial = '2', choices = SPEAKER_TYPE, widget=forms.Select(attrs={'class': 'form-control', 'autocomplete':'false'}), required=True)
